...
// ══════════════════════════════
const SHEET_API = "https://script.google.com/macros/s/AKfycbzlRPkIC3PNQDjH9NqPF8pOo6TB0Mz95Il6B18R1ovPnVgr6e7MggxwUuKvUp_HkPtW/exec";
...
let products = JSON.parse(localStorage.getItem('sama_products')) || [
  {id:1,cat:'keychains',name:'Chicken with Flowers',desc:'كتكوت لطيف مع ورود كروشيه ♡',price:46,oldPrice:0,stock:10,img:'images/1.png'},
  {id:2,cat:'keychains',name:'Strawberry Keychain',desc:'سلسلة مفاتيح فراولة لطيفة ♡',price:48,oldPrice:60,stock:8,img:'images/2.png'},
  {id:3,cat:'keychains',name:'Romantic Fllouss',desc:'كتكوت ضريف يحمل قلب أحمر',price:62,oldPrice:0,stock:5,img:'images/3.png'},
  {id:4,cat:'keychains',name:'Tomato Keychain',desc:'سلسلة مفاتيح طماطم مضحكة ♡',price:56,oldPrice:0,stock:12,img:'images/4.png'},
  {id:5,cat:'keychains',name:'Nishinoya Volleyball',desc:'نيشينويا مع الكرة الطائرة - Haikyuu ♡',price:57,oldPrice:0,stock:3,img:'images/5.png'},
  {id:6,cat:'keychains',name:'Hinata Volleyball',desc:'هيناتا مع الكرة الطائرة - Haikyuu ♡',price:57,oldPrice:0,stock:4,img:'images/6.png'},
  {id:7,cat:'keychains',name:'Kaito Kid Keychain',desc:'كايتو كيد - شخصية لطيفة ♡',price:44,oldPrice:0,stock:7,img:'images/7.png'},
  {id:8,cat:'accessories',name:'Mikasa Scarf & Gloves',desc:'طقم وشاح وقفازات ميكاسا',price:289,oldPrice:350,stock:2,img:'images/8.png'},
  {id:9,cat:'accessories',name:'Crochet Gloves',desc:'قفازات كروشيه دافئة ♡',price:78,oldPrice:0,stock:6,img:'images/9.png'},
  {id:10,cat:'flowers',name:'Single Tulip',desc:'زهرة توليب واحدة جميلة ♡',price:25,oldPrice:0,stock:15,img:'images/10.png'},
  {id:11,cat:'dolls',name:'Graduation Girl Doll',desc:'فتاة تخرج بدفتر وطاقية',price:63,oldPrice:0,stock:4,img:'images/11.png'},
  {id:12,cat:'keychains',name:'Mini Scarf Keychain',desc:'سلسلة مفاتيح وشاح صغير ♡',price:28,oldPrice:0,stock:20,img:'images/12.png'},
  {id:13,cat:'dolls',name:'Sunflower Girl Doll',desc:'فتاة مع دوار الشمس ♡',price:70,oldPrice:0,stock:3,img:'images/13.png'},
  {id:14,cat:'flowers',name:'Single Carnation',desc:'زهرة قرنفل واحدة أنيقة ♡',price:60,oldPrice:0,stock:9,img:'images/14.png'},
  {id:15,cat:'flowers',name:'Bouquet of 4 Carnations',desc:'باقة من ٤ ورود قرنفل ♡',price:230,oldPrice:280,stock:2,img:'images/15.png'},
  {id:16,cat:'flowers',name:'Sunflower',desc:'دوار شمس كبير مشرق ♡',price:70,oldPrice:0,stock:5,img:'images/16.png'},
  {id:17,cat:'accessories',name:'Mirror Flower Crochet',desc:'مرآة الزهور كروشيه ♡',price:119,oldPrice:0,stock:3,img:'images/17.png'},
  {id:18,cat:'keychains',name:'Mushroom Keychain',desc:'سلسلة مفاتيح فطر لطيف ♡',price:44,oldPrice:0,stock:11,img:'images/18.png'},
  {id:19,cat:'keychains',name:'Octopus Keychain',desc:'سلسلة مفاتيح أخطبوط لطيف ♡',price:50,oldPrice:0,stock:8,img:'images/19.png'},
  {id:20,cat:'flowers',name:'Bouquet of Lily Flowers',desc:'زهرة زنبق أنيقة ♡',price:146,oldPrice:180,stock:2,img:'images/20.png'},
  {id:21,cat:'flowers',name:'Rose Flower',desc:'وردة كروشيه رومانسية ♡',price:62,oldPrice:0,stock:7,img:'images/21.png'},
  {id:22,cat:'dolls',name:'Large Handmade Doll',desc:'دمية كروشيه كبيرة وجميلة ♡',price:370,oldPrice:420,stock:1,img:'images/22.png'},
  {id:23,cat:'dolls',name:'Ramadan Character Doll',desc:'شخصية رمضان مع فانوس ♡',price:325,oldPrice:0,stock:2,img:'images/23.png'},
  {id:24,cat:'dolls',name:'Mini Pig Doll',desc:'خنزير صغير كروشيه لطيف ♡',price:85,oldPrice:0,stock:5,img:'images/24.png'},
  {id:25,cat:'keychains',name:'Teddy Bear Keychain',desc:'دبدوب صغير سلسلة مفاتيح ♡',price:45,oldPrice:0,stock:14,img:'images/25.png'},
  {id:26,cat:'keychains',name:'Romantic Fllouss 2',desc:'سلسلة مفاتيح كتكوت يحمل وردة ♡',price:65,oldPrice:0,stock:6,img:'images/26.png'},
  {id:27,cat:'keychains',name:'Little Fllouss',desc:'سلسلة مفاتيح ورود صغيرة لطيفة ♡',price:40,oldPrice:0,stock:10,img:'images/27.png'},
  {id:28,cat:'dolls',name:'Batman Doll',desc:'دمية باتمان كروشيه مميزة',price:129,oldPrice:0,stock:3,img:'images/28.png'},
  {id:29,cat:'keychains',name:'Mini Flowers',desc:'سلسلة مفاتيح ورود صغيرة جداً ♡',price:25,oldPrice:0,stock:18,img:'images/29.png'},
  {id:30,cat:'keychains',name:'Chicken Bo3o',desc:'دجاجة بوعو لطيفة سلسلة مفاتيح ♡',price:59,oldPrice:0,stock:7,img:'images/30.png'},
  {id:31,cat:'flowers',name:'Flowers Box',desc:'صندوق ورود كروشيه جميل ♡',price:79,oldPrice:0,stock:4,img:'images/31.png'},
  {id:32,cat:'keychains',name:'Little Bear',desc:'دب صغير سلسلة مفاتيح لطيف ♡',price:45,oldPrice:0,stock:9,img:'images/32.png'},
  {id:33,cat:'accessories',name:'Book Marker',desc:'علامة كتاب كروشيه مميزة ♡',price:25,oldPrice:0,stock:20,img:'images/33.png'},
  {id:34,cat:'accessories',name:'Gold Earrings',desc:'أقراط ذهبية كروشيه ♡',price:43,oldPrice:0,stock:6,img:'images/34.png'},
  {id:35,cat:'accessories',name:'Flower Earrings',desc:'أقراط الورود كروشيه ♡',price:45,oldPrice:0,stock:8,img:'images/35.png'},
  {id:36,cat:'keychains',name:'Naruto Keychain',desc:'ناروتو من انمي ناروتو ♡',price:40,oldPrice:0,stock:10,img:'images/36.png'},
  {id:37,cat:'keychains',name:'Gojo Satoru Keychain',desc:'جوجو من انمي جوجتسو كايسن ♡',price:45,oldPrice:0,stock:7,img:'images/37.png'},
  {id:38,cat:'accessories',name:'Strawberry Earrings',desc:'أقراط فراولة كروشيه ♡',price:43,oldPrice:0,stock:5,img:'images/38.png'},
  {id:39,cat:'keychains',name:'Panda',desc:'باندا كروشيه لطيف ♡',price:40,oldPrice:0,stock:11,img:'images/39.png'},
  {id:40,cat:'keychains',name:'Spider-Man',desc:'سلسلة مفاتيح للرجل العنكبوت ♡',price:50,oldPrice:0,stock:8,img:'images/40.png'},
  {id:41,cat:'flowers',name:'Bouquet Flowers',desc:'ورود كروشيه جميلة ♡',price:279,oldPrice:320,stock:2,img:'images/41.png'},
  {id:42,cat:'keychains',name:'Kout-kout Twin',desc:'توأم كتاكيت لطيف بقبعة وردية ♡',price:42,oldPrice:0,stock:6,img:'images/42.png'},
  {id:43,cat:'accessories',name:'Rose Flower Earrings',desc:'أقراط ورود حمراء كروشيه ♡',price:45,oldPrice:0,stock:5,img:'images/43.png'},
  {id:44,cat:'keychains',name:'Daisy Chick Bag Charm',desc:'كتكوت أصفر ظريف بزهرة بيضاء، تعليقة شنطة أنيقة ♡',price:58,oldPrice:0,stock:8,img:'images/44.png'},
  {id:45,cat:'keychains',name:'Strawberry Bouquet Charm',desc:'قنينة فراولة صغيرة بزهرة بيضاء، تعليقة شنطة أو مفاتيح ♡',price:65,oldPrice:0,stock:7,img:'images/45.png'},
  {id:46,cat:'keychains',name:'Chick with Heart Keychain',desc:'كتكوت أصفر ظريف حامل قلب أحمر كروشيه ♡',price:48,oldPrice:0,stock:12,img:'images/46.png'},
  {id:47,cat:'keychains',name:'Cherry Tomato Keychain',desc:'طماطم حمراء ظريفة بوجه مبتسم، سلسلة مفاتيح ♡',price:42,oldPrice:0,stock:14,img:'images/47.png'},
  {id:48,cat:'keychains',name:'Volleyball Player Keychain',desc:'لاعب كرة طائرة مع الكرة، تعليقة مزدوجة ظريفة ♡',price:62,oldPrice:0,stock:6,img:'images/48.png'},
  {id:49,cat:'keychains',name:'Curly Hair Player Keychain',desc:'شخصية بشعر مجعد أحمر مع كرة طائرة، تعليقة مزدوجة ♡',price:62,oldPrice:0,stock:6,img:'images/49.png'},
  {id:50,cat:'keychains',name:'Gentleman Keychain',desc:'شخصية أنيقة بقبعة ونظارة وربطة عنق حمراء ♡',price:55,oldPrice:0,stock:8,img:'images/50.png'},
  {id:51,cat:'accessories',name:'Rose Scarf & Gloves Set',desc:'طقم وشاح وقفازات بدون أصابع، مطرز بورود حمراء، دافئ وأنيق ♡',price:195,oldPrice:230,stock:3,img:'images/51.png'},
  {id:52,cat:'accessories',name:'Olive Wrist Warmers',desc:'قفازات كروشيه بدون أصابع، لون زيتوني هادئ ♡',price:85,oldPrice:0,stock:7,img:'images/52.png'},
  {id:53,cat:'flowers',name:'Single Purple Tulip Bouquet',desc:'توليب بنفسجي واحد ملفوف بورق أنيق، هدية بسيطة ♡',price:38,oldPrice:0,stock:10,img:'images/53.png'},
  {id:54,cat:'keychains',name:'Beret Girl Keychain',desc:'فتاة أنيقة ببيريه أسود وشعر مجعد، سلسلة مفاتيح ♡',price:55,oldPrice:0,stock:6,img:'images/54.png'},
  {id:55,cat:'keychains',name:'Mini Scarf Bag Charm',desc:'وشاح صغير عنابي، تعليقة شنطة لطيفة ♡',price:35,oldPrice:0,stock:12,img:'images/55.png'},
  {id:56,cat:'dolls',name:'Sunflower Crown Doll',desc:'دمية بفستان أصفر وتاج ورود، تفاصيل دقيقة جداً ♡',price:105,oldPrice:0,stock:3,img:'images/56.png'},
  {id:57,cat:'flowers',name:'Fluffy Pink Peony',desc:'زهرة بيوني وردية منفوشة بساق وأوراق خضراء ♡',price:68,oldPrice:0,stock:6,img:'images/57.png'},
  {id:58,cat:'flowers',name:'Roses Bouquet in Vase',desc:'باقة ورود متعددة الألوان (أحمر، وردي، عنابي)، هدية فاخرة ♡',price:265,oldPrice:310,stock:3,img:'images/58.png'},
  {id:59,cat:'flowers',name:'Sunflower & Daisy Bouquet',desc:'باقة دوار الشمس مع أقحوان أبيض، مغلفة بشكل أنيق ♡',price:195,oldPrice:0,stock:3,img:'images/59.png'},
  {id:60,cat:'accessories',name:'Strawberry Blossom Earrings',desc:'أقراط فراولة معلقة بزهرة بيضاء، خفيفة وأنيقة ♡',price:48,oldPrice:0,stock:9,img:'images/60.png'},
  {id:61,cat:'keychains',name:'Ghost Friends Keychain',desc:'شبح ظريف بقبعة ملونة، سلسلة مفاتيح ♡',price:45,oldPrice:0,stock:10,img:'images/61.png'},
  {id:62,cat:'keychains',name:'Curly Jellyfish Keychain',desc:'قنديل بحر بأذرع متعرجة، تفاصيل دقيقة، تعليقة مميزة ♡',price:68,oldPrice:0,stock:6,img:'images/62.png'},
  {id:63,cat:'flowers',name:'Blue Lily Bouquet',desc:'باقة زنابق زرقاء وكحلية فاخرة مع بطاقة تهنئة ♡',price:275,oldPrice:320,stock:2,img:'images/63.png'}
];
