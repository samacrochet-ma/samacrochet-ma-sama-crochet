...
async function loadOrders() {
  const data = await apiCallPlain('getOrders', adminPassword).catch(() => null);
  // fallback: GET without password since getOrders is not a protected action server-side by default
  let orders = [];
  try {
